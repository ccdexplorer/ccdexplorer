...
# from ccdexplorer.cis import MongoTypeLoggedEvent
...
class CCD_ContractAddress(BaseModel):
    ...
    def from_index(cls, index: int, subindex: int):
        ...
        Returns:
            CCD_ContractAddress (CCD_ContractAddress): An instance of CCD_ContractAddress initialized with the provided index and subindex.
        """
...
class CCD_LockId(BaseModel):
    ...
    GRPC documentation: [concordium.v2.plt.LockId](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.plt.LockId)

    Attributes:
        account_index (int): The account index of the account that created the lock.
        sequence_number (int): The sequence number of the transaction that created the lock.
        creation_order (int): The 0-based creation order of the lock within the transaction that created it.
    """
...
class CCD_LockCreateEvent(BaseModel):
    ...
    GRPC documentation: [concordium.v2.plt.LockCreateEvent](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.plt.LockCreateEvent)

    Attributes:
        lock_id (CCD_LockId): The Lock ID of the newly-created lock.
        lock_config (CCD_Cbor): The CBOR-encoded configuration of the lock.
    """

    lock_id: CCD_LockId
    lock_config: CCD_Cbor


class CCD_LockDestroyEvent(BaseModel):
    """A lock was destroyed. Before this event can occur, the balance controlled by the lock must be zero.

    GRPC documentation: [concordium.v2.plt.LockDestroyEvent](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.plt.LockDestroyEvent)

    Attributes:
        lock_id (CCD_LockId): The Lock ID of the destroyed lock.
    """
...
class CCD_InitializationParameters(BaseModel):
    ...
    initial_supply: Optional[CCD_TokenAmount] = Field(default=None, alias="initialSupply")
...
class CCD_TokenTransferEvent(BaseModel):
    ...
    from_lock: Optional[CCD_LockId] = None
    to_lock: Optional[CCD_LockId] = None
    token_id: Optional[CCD_TokenId] = None
...
class CCD_MetaEvent(BaseModel):
    """An event that can occur during execution of a meta-update transaction.

    GRPC documentation: [concordium.v2.plt.MetaEvent](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.plt.MetaEvent)

    Attributes:
        module_event (Optional[CCD_TokenModuleEvent]): An event emitted by the token module.
        transfer_event (Optional[CCD_TokenTransferEvent]): An event emitted when a transfer of tokens is performed.
        mint_event (Optional[CCD_TokenSupplyUpdateEvent]): An event emitted when the token supply is updated by minting tokens.
        burn_event (Optional[CCD_TokenSupplyUpdateEvent]): An event emitted when the token supply is updated by burning tokens.
        lock_create_event (Optional[CCD_LockCreateEvent]): A lock creation event.
        lock_destroy_event (Optional[CCD_LockDestroyEvent]): A lock destruction event.
    """
...
class CCD_MetaEffect(BaseModel):
    """Events originating from a meta-update transaction.

    GRPC documentation: [concordium.v2.plt.MetaEffect](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.plt.MetaEffect)

    Attributes:
        events (list[CCD_MetaEvent]): The events generated by the meta-update transaction.
    """

    events: list[CCD_MetaEvent]


class CCD_TokenAuthorizations(BaseModel):
    """The authorizations for a token. The actual authorizations are found in the CBOR encoded details.

    GRPC documentation: [concordium.v2.plt.TokenAuthorizations](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.plt.TokenAuthorizations)

    Attributes:
        token_id (CCD_TokenId): The canonical token identifier.
        details (CCD_Cbor): The CBOR encoded authorizations for the token.
    """
...
class CCD_LockInfo(BaseModel):
    """Information about a PLT lock.

    GRPC documentation: [concordium.v2.LockInfo](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.LockInfo)

    Attributes:
        lock_info (CCD_Cbor): CBOR-encoded lock information.
    """
...
class CCD_RejectReason_LockOperationNotAuthorized(BaseModel):
    """The account is not authorized to perform the requested lock operation.

    GRPC documentation: [concordium.v2.RejectReason.LockOperationNotAuthorized](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.RejectReason.LockOperationNotAuthorized)

    Attributes:
        lock_id (CCD_LockId): The Lock ID of the lock involved in the operation.
        account (CCD_AccountAddress): The account that attempted the unauthorized operation.
    """
...
class CCD_RejectReason_LockTokenNotPermitted(BaseModel):
    """The lock does not allow funding with the particular token.

    GRPC documentation: [concordium.v2.RejectReason.LockTokenNotPermitted](https://docs.concordium.com/concordium-grpc-api/#concordium.v2.RejectReason.LockTokenNotPermitted)

    Attributes:
        lock_id (CCD_LockId): The Lock ID of the lock that rejected the token.
        token_id (CCD_TokenId): The Token ID that is not permitted by the lock.
    """
...
class CCD_RejectReason(BaseModel):
    ...
    non_existent_lock_id: Optional[CCD_LockId] = None
    lock_expired: Optional[CCD_LockId] = None
    lock_fund_not_authorized: Optional[CCD_RejectReason_LockOperationNotAuthorized] = None
    lock_send_not_authorized: Optional[CCD_RejectReason_LockOperationNotAuthorized] = None
    lock_return_not_authorized: Optional[CCD_RejectReason_LockOperationNotAuthorized] = None
    lock_cancel_not_authorized: Optional[CCD_RejectReason_LockOperationNotAuthorized] = None
    lock_token_not_permitted: Optional[CCD_RejectReason_LockTokenNotPermitted] = None
    lock_recipient_not_permitted: Optional[CCD_RejectReason_LockOperationNotAuthorized] = None
...
class CCD_BakerEvent(BaseModel):
    ...
    baker_set_transaction_fee_commission: Optional[CCD_BakerSetTransactionFeeCommission] = None
    baker_set_baking_reward_commission: Optional[CCD_BakerSetBakingRewardCommission] = None
...
class CCD_AuthorizationsV1(BaseModel):
    ...
    create_plt: Optional[CCD_AccessStructure] = None
...
class CCD_BlockSpecialEvent(BaseModel):
    ...
    payday_foundation_reward: Optional[CCD_BlockSpecialEvent_PaydayFoundationReward] = None
...
class CCD_PersistentRoundStatus(BaseModel):
    ...
    Attributes:
        ...
        last_baked_round (CCD_Round): The last round in which this node baked a block. Note that in the GRPC implementation, if the value equals the default value, it's not sent. Hence an Optional with default value of False.
...
class CCD_BlockTableSummary(BaseModel):
    ...
    Attributes:
        dead_block_cache_size (int): The size of the dead block cache. Note that inn the GRPC implementation, if the value equals the default value, it's not sent. Hence an Optional with default value of 0.
...
class CCD_ConsensusDetailedStatus(BaseModel):
    ...
    Attributes:
        ...
        non_finalized_transaction_count (int): The count of non-finalized transactions. Note that in the GRPC implementation, if the value equals the default value, it's not sent. Hence an Optional with default value of 0.
        transaction_table_purge_counter (int): The counter for purging the transaction table. Note that in the GRPC implementation, if the value equals the default value, it's not sent. Hence an Optional with default value of 0.
