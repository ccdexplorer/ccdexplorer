...
class s7_InventoryTransferParams_ERC721_V1(BaseModel):
    custom_token_id: int
...
class s7_InventoryTransferFromParams_ERC721_V2(BaseModel):
    custom_token_id: int
    from_: CCD_AccountAddress
    to_: Optional[CCD_AccountAddress] = None
...
class s7_erc721_v1_AddTraderEvent(BaseModel):
    type: int
    trader: CCD_ContractAddress


class s7_erc721_v1_BuyingEvent(BaseModel):
    type: int
    custom_token_id: int
    from_: CCD_AccountAddress
    to_: CCD_AccountAddress
...
class s7_erc721_v1_OnSaleEvent(BaseModel):
    type: int
    custom_token_id: int
...
class s7_erc721_v1_TransferEvent(BaseModel):
    type: int
    custom_token_id: int
    from_: Optional[CCD_AccountAddress] = None
    to_: CCD_AccountAddress
...
class s7_erc721_v2_TransferEvent(BaseModel):
    type: int
    custom_token_id: int
    from_: Optional[CCD_AccountAddress] = None
    to_: Optional[CCD_AccountAddress] = None
...
class s7_erc721_v2_BuyingEvent(BaseModel):
    type: int
    custom_token_id: int
    from_: CCD_AccountAddress
    to_: CCD_AccountAddress
...
class s7_erc721_v2_OnSaleEvent(BaseModel):
    type: int
    custom_token_id: int
    price: microCCD
    sender: CCD_AccountAddress | CCD_ContractAddress
...
class s7_erc721_v2_PauseEvent(BaseModel):
    type: int
    custom_token_id: int
    sender: CCD_AccountAddress | CCD_ContractAddress


class s7_erc721_v2_AddTraderEvent(BaseModel):
    type: int
    trader: CCD_ContractAddress


class s7_erc721_v2_ClosedEvent(BaseModel):
    type: int
    custom_token_id: int
    sender: CCD_AccountAddress | CCD_ContractAddress


class s7_erc721_v2_CreatedEvent(BaseModel):
    type: int
    custom_token_id: int
    creator: CCD_AccountAddress
    trader: CCD_ContractAddress
...
class s7_erc1155_v1_BuyingEvent(BaseModel):
    type: int
    custom_token_id: int
    value: int
    lot_id: int
...
class s7_erc1155_v1_OnSaleEvent(BaseModel):
    type: int
    custom_token_id: int
    value: int
    lot_id: int
...
class s7_erc1155_v1_PauseEvent(BaseModel):
    type: int
    custom_token_id: int
    value: int
    lot_id: int
...
class s7_erc1155_v1_AddTraderEvent(BaseModel):
    type: int
    trader: CCD_ContractAddress


class s7_erc1155_v1_CreateEvent(BaseModel):
    type: int
    custom_token_id: int
    value: int
    creator: CCD_AccountAddress
...
class SpaceSevenEvents:
    def custom_token_id(self, bs: io.BytesIO) -> int:
        return int.from_bytes(bs.read(8), byteorder="little")

    # erc721_v1
    def s7_erc721_v1_inventory_transfer_event(self, cis: CIS, hexParameter: str):
        ...
        from_ = cis.account_address(bs) if optional else None

        to_ = cis.account_address(bs)

        return s7_erc721_v1_TransferEvent(
            **{
                "type": type_,
    ...
    def s7_erc721_v1_inventory_on_sale_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        sender = cis.address(bs)
        trader = cis.contract_address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc721_v1_OnSaleEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "sender": sender,
    ...
    def s7_erc721_v1_inventory_buying_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)

        from_ = cis.account_address(bs)

        to_ = cis.account_address(bs)

        return s7_erc721_v1_BuyingEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "from_": from_,
    ...
    def s7_erc721_v1_inventory_add_trader_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        trader = cis.contract_address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc721_v1_AddTraderEvent(**{"type": type_, "trader": trader})

    # erc721_v2
    def s7_erc721_v2_inventory_transfer_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        ...
        from_ = cis.account_address(bs) if optional else None
        optional = int.from_bytes(bs.read(1), "little")
        to_ = cis.account_address(bs) if optional else None

        return s7_erc721_v2_TransferEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "from_": from_,
    ...
    def s7_erc721_v2_inventory_on_sale_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        price = cis.ccd_amount(bs)
        sender = cis.address(bs)
        trader = cis.contract_address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc721_v2_OnSaleEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "price": price,
    ...
    def s7_erc721_v2_inventory_buying_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        ...
        return s7_erc721_v2_BuyingEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "from_": from_,
    ...
    def s7_erc721_v2_inventory_pause_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        sender = cis.address(bs)
        return s7_erc721_v2_PauseEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "sender": sender,
    ...
    def s7_erc721_v2_inventory_closed_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        sender = cis.address(bs)
        return s7_erc721_v2_ClosedEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "sender": sender,
    ...
    def s7_erc721_v2_inventory_add_trader_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        trader = cis.contract_address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc721_v2_AddTraderEvent(
            **{
                "type": type_,
                "trader": trader,
            }
    ...
    def s7_erc721_v2_inventory_created_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        creator = cis.account_address(bs)
        trader = cis.contract_address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc721_v2_CreatedEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "creator": creator,
    ...
    # erc1155_v1
    def s7_erc1155_v1_inventory_transfer_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
    ...
    def s7_erc1155_v1_inventory_on_sale_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        value = int.from_bytes(bs.read(8), byteorder="little")
        ...
        trader = cis.contract_address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc1155_v1_OnSaleEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "value": value,
    ...
    def s7_erc1155_v1_inventory_buying_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        value = int.from_bytes(bs.read(8), byteorder="little")
        ...
        from_ = cis.account_address(bs)
        to_ = cis.account_address(bs)
        trader = cis.address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc1155_v1_BuyingEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "value": value,
    ...
    def s7_erc1155_v1_inventory_pause_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        value = int.from_bytes(bs.read(8), byteorder="little")
        ...
        trader = cis.contract_address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc1155_v1_PauseEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "value": value,
    ...
    def s7_erc1155_v1_inventory_add_trader_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        trader = cis.contract_address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc1155_v1_AddTraderEvent(
            **{
                "type": type_,
                "trader": trader,
            }
    ...
    def s7_erc1155_v1_inventory_create_event(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        type_ = int.from_bytes(bs.read(1), "little")
        custom_token_id = self.custom_token_id(bs)
        value = int.from_bytes(bs.read(8), byteorder="little")
        ...
        trader = cis.contract_address(bs)
        trader = CCD_ContractAddress.from_str(f"<{trader[0]},{trader[1]}>")
        return s7_erc1155_v1_CreateEvent(
            **{
                "type": type_,
                "custom_token_id": custom_token_id,
                "value": value,
    ...
    def s7_inventory_transfer_erc721_v1_transfer_parameter(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        custom_token_id = self.custom_token_id(bs)
        to_ = cis.account_address(bs)
        return s7_InventoryTransferParams_ERC721_V1(
            **{
                "custom_token_id": custom_token_id,
                "to_": to_,
            }
    ...
    def s7_inventory_transfer_erc721_v2_transfer_parameter(self, cis: CIS, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        custom_token_id = self.custom_token_id(bs)
        optional = int.from_bytes(bs.read(1), "little")
        to_ = None
    ...
    def s7_inventory_create_erc1155_v1_create_parameter(self, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        custom_token_id = self.custom_token_id(bs)
        value = int.from_bytes(bs.read(8), byteorder="little")
        optional = int.from_bytes(bs.read(1), "little")
    ...
    def s7_inventory_safe_transfer_from_erc721_v2_parameter(self, hexParameter: str):
        bs = io.BytesIO(bytes.fromhex(hexParameter))
        custom_token_id = self.custom_token_id(bs)
        from_ = self.account_address(bs)
        optional = int.from_bytes(bs.read(1), "little")
        to_ = None
        if optional:
            to_ = self.account_address(bs)
        return s7_InventoryTransferFromParams_ERC721_V2(
            **{
                "custom_token_id": custom_token_id,
                "from_": from_,
                "to_": to_,
