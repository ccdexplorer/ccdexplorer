...
@router.get("/{net}/token/{contract_index}/{contract_subindex}/{token_id}")  # type:ignore
...
async def get_cis2_token_holders_paginated(
    ...
    stored_token_address: dict | None = api_result.return_value if api_result.ok else None
