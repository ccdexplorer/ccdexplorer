...
async def staking(
    ...
    if net == "mainnet":
        ...
        for pool in all_pools:
            if "baker_id" in pool:
                made_up_pools.append(create_dict_for_tabulator_display_for_pools("mainnet", pool))
        suspended_data = []
            ...
            suspended_data.append(
                {
                    ...
                    "count_of_primed": f'<span class="ccd">{
                        len(
                    ...
                    "suspended_days_download": humanize_age(dateutil.parser.parse(value[0])),
...
async def get_ajax_payday_passive(
    ...
    html = request.app.templates.get_template("staking/staking_passive_info_rewards.html").render(
        {
