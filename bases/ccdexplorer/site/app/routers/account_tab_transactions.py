...
@router.get("/account/transactions-tab-content/{net}/{account_id}", response_class=HTMLResponse)
async def transactions_tab_content(
    ...
    return request.app.templates.get_template("account/account_transactions.html").render(
        {
            "net": net,
