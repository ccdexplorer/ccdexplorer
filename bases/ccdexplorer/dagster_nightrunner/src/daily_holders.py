...
from ..nightrunner.update_daily_holders import perform_data_for_daily_holders
...
def daily_holders(
    ...
    dct = {}
    dct: dict = perform_data_for_daily_holders(context, partition_date, commits_by_day, mongodb)
    return dct


defs = dg.Definitions(
    assets=[daily_holders],
    resources={
