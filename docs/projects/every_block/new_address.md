# MS Accounts (Project: `ms_accounts`)

The micro service listens to the Celery topic `account_creation` and starts processing when a new message arrives. The message contains the `account address`.
